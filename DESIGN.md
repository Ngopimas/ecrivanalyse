...
|------|----------|-----------|
| 2026-07-04 | **Le mur n'est plus cliquable** : les titres sont des `span`, texture pure (déjà aria-hidden ; /archive reste la liste navigable). | Les fenêtres interactives duraient une à trois secondes en plein mouvement, et un clic ailleurs signifie « passer l'animation » : les deux sens du clic se disputaient une cible mouvante. Le survol invitait à un geste que la chorégraphie ne laissait pas accomplir ; la sélection appartient à la rencontre et à l'archive. En prime, ~3 000 href de moins dans la page. |
